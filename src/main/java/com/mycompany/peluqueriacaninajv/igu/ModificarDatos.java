...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmvAlergico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmvAlergicoActionPerformed(evt);
            }
        });
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarMascota(masco,nombreMaco,razaMaco,colorMaco,observaciones,alergico,atesp,nombreDuenio,celDuenio);
        
        //Nuestro Mensaje de que se edito con exito
    ...
    private void cmvAlergicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmvAlergicoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmvAlergicoActionPerformed
    ...
    private void cargarDatos(int num_cliente) {
       ...
       txtNombre.setText(masco.getNombre());
        ...
        if(masco.getAlergico().equals("SI")){
            cmvAlergico.setSelectedIndex(1);
            
        }else{
            if(masco.getAlergico().equals("No"))
            cmvAlergico.setSelectedIndex(2);
        }
        
         if(masco.getAtencion_especial().equals("SI")){
           cmdAtesp.setSelectedIndex(1);
            
        }else{
            if(masco.getAtencion_especial().equals("No"))
            cmdAtesp.setSelectedIndex(2);
        }
